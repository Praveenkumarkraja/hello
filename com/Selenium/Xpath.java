...
public class Xpath {
	public static void main(String[] args) {
		...
		user.sendKeys("9597640637");
		WebElement button = driver.findElement(By.xpath("//input[@tabindex='5']"));
		button.click();
		//WebElement text = driver.findElement(By.xpath("//label[contains(text(),'Email')]"));
	    //System.out.println(text.getText());
		WebElement password = driver.findElement(By.xpath("//input[@tabindex='2']"));
		password.sendKeys("258741");
